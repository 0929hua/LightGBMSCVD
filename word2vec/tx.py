...
if __name__ == "__main__":
    conOpCodesPath = 'D:/pyProjects/pythonProject/second/dataSet/tx/'
    ...
    for file in conOpCodesPathList:
        if file.__eq__('D:/pyProjects/pythonProject/second/dataSet/tx/399.txt'):
                begin_time = time.time()
                print(begin_time)
    ...
    with open("tx/labelListTX.txt", "w") as fp:
