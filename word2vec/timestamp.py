...
if __name__ == "__main__":
    conOpCodesPath = 'D:/pyProjects/pythonProject/RFVulnerabilityDetection/dataset/opcodes/timestamp/'
    ...
    with open("timestamp/labelListTIMEs.txt", "w") as fp:
