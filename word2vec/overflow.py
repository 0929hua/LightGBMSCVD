...
if __name__ == "__main__":
    conOpCodesPath = 'D:/pyProjects/pythonProject/RFVulnerabilityDetection/dataset/opcodes/overflow/'
    #conOpCodesPath = 'D:/pyProjects/pythonProject/MachineLearningVulnerabilityDetection/flow'
    ...
    with open("overflow/labelListOVER.txt", "w") as fp:
        # 二维数组遍历，列表生成式, 省去写for循环
        # "\n".join表示把每一行之后加入换行符
        # " ".join表示把每一行不同字符之间加入空格
