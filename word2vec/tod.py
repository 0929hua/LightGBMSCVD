...
if __name__ == "__main__":
    conOpCodesPath = 'D:/pyProjects/pythonProject/RFVulnerabilityDetection/dataset/opcodes/tod/'
    #conOpCodesPath = 'D:/pyProjects/pythonProject/RFVulnerabilityDetection/flow'
    ...
    with open("tod/labelListTODs.txt", "w") as fp:
