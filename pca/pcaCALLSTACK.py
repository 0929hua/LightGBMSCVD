...
dataMat= np.loadtxt('D:/pyProjects/pythonProject/second/word2vec/callstack/labelListSTACKs.txt',dtype=np.float64)
print(dataMat)
...
with open("callstack/callstackPCA.txt", "w") as fp:
