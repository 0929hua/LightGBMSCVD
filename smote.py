...
def savaToExcel(data_resampled):
    ...
    将dataframe存储到excel中
    '''
    outputPath = 'D:/pyProjects/pythonProject/second/csv/smote/allSmote.xlsx'
...
if __name__ == '__main__':
    ...
    col_name = ['特征1', '特征2', '特征3', '专业类别']
    dataset = pd.read_csv('D:/pyProjects/pythonProject/second/csv/origin/all.csv', engine='python')
    ...
    data_resampled = np.zeros([len(y_resampled), 4]) # 构造 40 x 7 的元素为0的矩阵
