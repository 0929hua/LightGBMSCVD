...
def train(X_train, X_test, y_train, y_test):
    ...
    # 模型保存
    dump(model, 'xgboostSMOTE.joblib')
...
#加载模型
clf = load('xgboostSMOTE.joblib')
y_pred = [round(value) for value in clf.predict(x_pred)]
print('y_pred：', y_pred)
acc(y_true, y_pred)
#
#1  # 第一类漏洞数量：2005 第二类漏洞数量：9  第三类漏洞数量：11 第四类漏洞数量：43 第五类漏洞：1  第六类漏洞 ：4
...
#2  # 第一类漏洞数量：11  第二类漏洞数量：1892 第三类漏洞数量：2  第四类漏洞数量：110 第五类漏洞：32  第六类漏洞 ：26
...
#3  # 第一类漏洞数量：26  第二类漏洞数量：17  第三类漏洞数量：1978  第四类漏洞数量：16 第五类漏洞：10  第六类漏洞 ：26
...
#4  # 第一类漏洞数量：44  第二类漏洞数量：65  第三类漏洞数量：5  第四类漏洞数量：1953 第五类漏洞：3  第六类漏洞 ：3
...
#5  # 第一类漏洞数量：2  第二类漏洞数量：31  第三类漏洞数量：3  第四类漏洞数量：0 第五类漏洞：2037  第六类漏洞 ：0
...
#6  # 第一类漏洞数量：7  第二类漏洞数量：9  第三类漏洞数量：3  第四类漏洞数量：9 第五类漏洞：1  第六类漏洞：2044
