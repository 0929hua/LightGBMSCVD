...
#加载模型
clf = load('svmSmoteTT.joblib')
y_pred = [round(value) for value in clf.predict(x_pred)]
print('y_pred：', y_pred)
acc(y_true, y_pred)

#1  # 第一类漏洞数量：1055  第二类漏洞数量：3  第三类漏洞数量：11  第四类漏洞数量：21 第五类漏洞：2  第六类漏洞 ：3
...
#2  # 第一类漏洞数量：110  第二类漏洞数量：1969  第三类漏洞数量：6  第四类漏洞数量：53 第五类漏洞：17  第六类漏洞 ：9
...
#3  # 第一类漏洞数量：32  第二类漏洞数量：18  第三类漏洞数量：1981 第四类漏洞数量：13 第五类漏洞：12  第六类漏洞 ：21
...
#4  # 第一类漏洞数量：682  第二类漏洞数量：41  第三类漏洞数量：1  第四类漏洞数量：1992 第五类漏洞：0  第六类漏洞 ：1
...
#5  # 第一类漏洞数量：9  第二类漏洞数量：15  第三类漏洞数量：1  第四类漏洞数量：1 第五类漏洞：2042  第六类漏洞 ：0
...
#6  # 第一类漏洞数量：69  第二类漏洞数量：11  第三类漏洞数量：4  第四类漏洞数量：10 第五类漏洞：0  第六类漏洞：2030
